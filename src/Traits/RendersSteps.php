...
trait RendersSteps {
    ...
    /**
     * Register sync operations for all wizards early in the lifecycle
     *
     * Called on admin_init so the inline-sync library has time to hook
     * admin_enqueue_scripts and register its REST routes before the
     * page renders. Only registers syncs for the wizard currently being
     * viewed (matched by ?page= parameter).
     *
     * @return void
     * @since 1.0.0
     */
